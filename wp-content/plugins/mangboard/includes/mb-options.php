...
$mb_options				= array("locale"=>get_locale(),		//ko_KR, en_US   (DB에서 설정 불가)
										...
										"make_img_small_size"=>"120",			//지정된 크기로 업로드 이미지의 축소된 비율의 이미지를 생성 : 모델에서 ("field":"fn_image_path","size":"small") 사이즈 지정 가능, small 이미지가 없으면 원본 이미지를 불러옴
