<?php
	...
	$write_model				= mbw_json_decode(mbw_get_model("write"));
	...
	if(mbw_get_param("board_action")=="modify" || mbw_get_param("board_action")=="reply" || mbw_get_param("board_action")=="copy"){
		...
		if(mbw_get_param("board_action") == "reply"){
			$column		= $mb_fields["select_board"]["fn_gid"].",".$mb_fields["select_board"]["fn_reply"].",".$mb_fields["select_board"]["fn_reply_depth"].",".$mb_fields["select_board"]["fn_title"].",".$mb_fields["select_board"]["fn_category1"].",".$mb_fields["select_board"]["fn_category2"].",".$mb_fields["select_board"]["fn_category3"];
...
?>
<input type="hidden" name="calendar_date" id="calendar_date" value="<?php echo mbw_get_param("calendar_date");?>" />
<?php 
}
