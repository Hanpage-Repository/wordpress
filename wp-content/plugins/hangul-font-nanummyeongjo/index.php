...
/*
  Plugin Name: 한글폰트 나눔명조
  Plugin URI: http://www.iamgood.co.kr
  Description: 한글폰트 나눔명조
...
/* Copyright 2014 Hangul Font nanummyeongjo (email : consult@iamgood.co.kr)
...
hf_Main_class::instance('나눔명조', 'nanummyeongjo', __FILE__);
?>
