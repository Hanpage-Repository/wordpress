...
$mb_schema["users"]		= "(
  ...
  `wp_user_pid` int(20) unsigned NOT NULL DEFAULT '0',
  ...
  `allow_mailing` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `allow_message` tinyint(3) unsigned NOT NULL DEFAULT '0',
...
$mb_schema["board_options"]	= "(
  ...
  `point_board_read` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `point_board_write` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `point_board_reply` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `point_comment_write` tinyint(3) unsigned NOT NULL DEFAULT '0',
