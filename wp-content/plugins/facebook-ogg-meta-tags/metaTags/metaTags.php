<?php
	...
	class metaTags{
		public $Signature = array(
			'pluginName'		=> 'Social Media Meta Tags',
			'pluginNiceName'	=> 'SocialMedia Meta Tags',
							...
							<div id="<?php echo $this->Signature['pluginSlug'];?>_container">
								...
								<div class="<?php echo $this->Signature['pluginSlug'];?>_service_content">
									 <div class="accordion-header">
										...
										<?php echo __('Enable Social Share Buttons', 'social-meta-tags');?>
									</div>		
