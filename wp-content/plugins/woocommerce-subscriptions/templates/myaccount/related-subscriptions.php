...
<header>
	<h2><?php 
	// edit by KH
	esc_html_e( '접수된 내역 - 정기결제', 'woocommerce-subscriptions' ); 
	//esc_html_e( 'Related Subscriptions', 'woocommerce-subscriptions' ); 
	?></h2>
</header>
<table class="shop_table shop_table_responsive my_account_orders">
	<thead>
		<tr>
			...
			// edit by KH
			esc_html_e( '번호', 'woocommerce-subscriptions' ); 
			//esc_html_e( 'Subscription', 'woocommerce-subscriptions' ); 
			?></span></th>
			<th class="order-date"><span class="nobr"><?php 
			// edit by KH
			esc_html_e( '상태', 'woocommerce-subscriptions' ); 
			//esc_html_e( 'Status', 'woocommerce-subscriptions' ); 
			?></span></th>
			<th class="order-status"><span class="nobr"><?php 
			// edit by KH
			//echo esc_html_x( 'Next Payment', 'table heading', 'woocommerce-subscriptions' ); 
			echo esc_html_x( '다음 결제일', 'table heading', 'woocommerce-subscriptions' ); 
			?></span></th>
			<th class="order-total"><span class="nobr"><?php 
			//echo esc_html_x( 'Total', 'table heading', 'woocommerce-subscriptions' ); 
			echo esc_html_x( '내용', 'table heading', 'woocommerce-subscriptions' ); 
			?></span></th>
