...
?>
		<item>
			...
			<link><![CDATA[<?php echo mbw_get_url(array('board_pid'=>mbw_get_board_item('fn_pid'),'mode'=>'view'),get_permalink(mbw_get_board_option("fn_post_id")));?>]]></link>
			<guid><![CDATA[<?php echo mbw_get_url(array('board_pid'=>mbw_get_board_item('fn_pid'),'mode'=>'view'),get_permalink(mbw_get_board_option("fn_post_id")));?>]]></guid>
