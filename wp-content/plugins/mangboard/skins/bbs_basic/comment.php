...
<?php
	echo '<div id="comment_add_list" class="cmt-add-list" style="display:none;">'.mbw_get_btn_template(array("name"=>"More","onclick"=>"sendCommentList()","class"=>"btn btn-more"))."</div>";
