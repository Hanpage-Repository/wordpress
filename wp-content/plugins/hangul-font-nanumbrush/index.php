...
/*
  Plugin Name: 한글폰트 나눔손글씨 붓
  Plugin URI: http://www.iamgood.co.kr
  Description: 한글폰트 나눔손글씨 붓
...
/* Copyright 2014 Hangul Font nanumbrush (email : consult@iamgood.co.kr)
...
hf_Main_class::instance('나눔손글씨 붓', 'nanumbrush', __FILE__);
?>
