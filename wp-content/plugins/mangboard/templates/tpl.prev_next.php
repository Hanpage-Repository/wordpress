	...
	function mbw_get_prev_next_html($data){
		...
		if($field_check){
			...
			if($check_field1==$check_field2){ //1차 단순 정렬일 경우
				$prev_add_query	= "((".$join_query.$mb_fields["select_board"][$check_field1].$check_sign1."'".mbw_get_board_item($check_field1)."'))";
				$next_add_query	= "((".$join_query.$mb_fields["select_board"][$check_field1].$check_sign2."'".mbw_get_board_item($check_field1)."'))";
			}else { //2차 정렬일 경우
				$prev_add_query	= "((".$join_query.$mb_fields["select_board"][$check_field1].$check_sign1."'".mbw_get_board_item($check_field1)."') or (".$join_query.$mb_fields["select_board"][$check_field1]."='".mbw_get_board_item($check_field1)."' AND ".$join_query.$mb_fields["select_board"][$check_field2]."<".mbw_get_board_item($check_field2)."))";
				$next_add_query	= "((".$join_query.$mb_fields["select_board"][$check_field1].$check_sign2."'".mbw_get_board_item($check_field1)."') or (".$join_query.$mb_fields["select_board"][$check_field1]."='".mbw_get_board_item($check_field1)."' AND ".$join_query.$mb_fields["select_board"][$check_field2].">".mbw_get_board_item($check_field2)."))";
			}			
