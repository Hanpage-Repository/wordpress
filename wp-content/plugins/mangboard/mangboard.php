...
function mbw_init(){	
	...
	mbw_set_params();
	if(empty($_COOKIE["mb_access_token"])){		
	...
	if(is_admin()){
		if(!empty($_GET["page"]) && strpos($_GET["page"], 'mbw_')===0 && $_GET["page"]!="mbw_dashboard"){
